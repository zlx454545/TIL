...
btnScrollTo.addEventListener('click', function (e) {
  const s1coodrs = section1.getBoundingClientRect();
  ...
  // SCrolling
  // window.scrollTo(
  //   s1coodrs.left + window.pageXOffset,
  //   s1coodrs.top + window.pageYOffset
  // );

  // window.scrollTo({
  //   left: s1coodrs.left + window.pageXOffset,
  //   top: s1coodrs.top + window.pageYOffset,
  //   behavior: 'smooth',
  // });
